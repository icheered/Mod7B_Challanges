...
@echo Compiling your medium access contol challenge client...
...
cl %cppfiles% /W3 /EHsc /std:c++latest /I framework /I my_protocol /Fo.\obj\ /link Ws2_32.lib /SUBSYSTEM:CONSOLE /out:My_MediumAccessControlCC.exe
